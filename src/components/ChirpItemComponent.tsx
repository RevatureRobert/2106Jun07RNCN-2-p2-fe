    ...
    <Pressable 
        ...
        <View style={styles.chirpContent}>
            ...
            <View style={{flex: 1, flexDirection: 'row', alignContent: 'center'}}>
                <MaterialCommunityIcons name="heart-outline" color="#ccc" size={20} style={{paddingTop: 5}}></MaterialCommunityIcons>
                <Text style={{color: '#ccc', alignSelf: 'center', paddingLeft: 5}}>0</Text>
            </View>
        </View>
